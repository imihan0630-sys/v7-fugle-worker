...
- Current cursor: CA-001 through CA-110 complete; continue from CA-111.
...
- CA-106 confirms official daily denominator source lanes on both exchanges. TWSE BFT51U raw-unit normalization is still UNKNOWN and full historical archive readiness is NO_GO; TPEx historical issued-share artifacts are verified at public-page level but stable long-run machine ingestion remains PARTIAL.
...
- CA-111 is in progress with `research/twse_bft51u_unit_resolution_receipt_v0_1.json`; strict BFT51U raw-unit proof remains unresolved. BFI85U/TRANISIN/T32 provide promising official reconciliation/trading-unit guards, but universal x1000 is still prohibited.
...
- Contiguous cursor remains after CA-110 until CA-111 closes; Formal Core remains locked.
- Exact continuation: close CA-111 with official TWSE raw-unit proof or a fully verified alternative daily share lane; then CA-113 bounded dual-exchange archive pilot/completeness receipts; CA-114 payment-certificate/private-placement denominator resolution with independent witness; CA-115 readiness re-evaluation.
