...
4. International evidence from Da, Gurun & Warachka's information-discreteness framework is directionally consistent: gradual/continuous information is associated with stronger return continuation than discrete/jumpy information.
...
2. Search Taiwan evidence on price-path/trend clarity and turnover-conditioned momentum to distinguish genuine incremental information from R03/R07/R08 redundancy.
