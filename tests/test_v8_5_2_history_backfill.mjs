...
assert.match(source,/const VERSION = "8\.5\.2-history-backfill";/);
for (const marker of [
...
console.log(JSON.stringify({ok:true,version:"8.5.2-history-backfill",recoveredRows:recovered.length}));
