...
assert.match(workerSource,/selectedCount:dailyPayload\.selectedCount,(?:zeroSelection:dailyPayload\.zeroSelection,pushRequired:true,)?checkedAt:new Date\(\)\.toISOString\(\)/);
